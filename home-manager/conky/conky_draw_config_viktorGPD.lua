...
--    conky_value = 'exec nvidia-smi --query-gpu="utilization.gpu" --format=csv,noheader,nounits',
    conky_value = 'exec /home/viktor/.local/bin/get_amdgpu_load.sh',
    from = {x = 6, y = 20},
    to = {x = 6, y = 0},
...
{
    kind = 'bar_graph',
    conky_value = 'exec iostat -dx /dev/nvme1n1 | awk \'/nvme1n1/ {print $16}\'',
    from = {x = 100, y = 20},
    to = {x = 100, y = 0},
    background_thickness = 4,
    bar_thickness = 4,
...
{
    kind = 'bar_graph',
    conky_value = 'exec iostat -dx /dev/sdb1 | awk \'/sda1/ {print $16}\'',
    from = {x = 110, y = 20},
    to = {x = 110, y = 0},
    background_thickness = 4,
    bar_thickness = 4,
